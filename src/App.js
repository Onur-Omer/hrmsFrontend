...
function App() {
  return (
    <div className="App">
      ...
      <Route exact path="/registerForEmployee" component={RegisterForEmployee} />
      <Route exact path="/registerForEmployer" component={RegisterForEmployer} />
      <Route exact path="/registerForPersonel" component={RegisterForPersonel} />
